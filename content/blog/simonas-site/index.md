...
tags:
  ...
  - post
draft: false
summary: Portfolio website redesign for a Brooklyn-based visual artist seeking prestigious residencies and gallery shows.
responsibilities:
  - Content Strategy
...
Now Simona can:
- Add a new exhibition by entering title, venue, location, and uploading images
- Link exhibitions to specific video works with a simple dropdown
...
These connections mirror how curators and gallerists actually explore an artist's practice—following threads, making connections, building context.

## The full-screen video homepage
...
We built the site following web standards and progressive enhancement principles:
- Clean, semantic HTML that works even without JavaScript
- CSS that adapts to user preferences (dark mode, reduced motion)
- Modern web platform features (CSS layers, scroll snap, view transitions)
- Fast load times and responsive design

The technical approach aligned with our content philosophy: simple, native, and focused on what matters.

## The result

Simona now has a website that:
- Reflects her current work (because updating is easy)
- Makes the right impression in seconds
- Works as a professional home base for social promotion
- Gives curators, gallerists, and juries what they need quickly
- Feels prestigious and international

More importantly, she has a system that grows with her practice. As she adds exhibitions, residencies, and new bodies of work, the site adapts without requiring redesign or technical intervention.
